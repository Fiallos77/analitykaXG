...
<!-- HERO SECTION -->
<section class="hero-section" style="background-image: url('{{ site.baseurl }}/assets/images/profile.jpg'); background-size: cover; background-position: center; position: relative;">
    <div style="position:absolute;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.65);z-index:0;"></div>
